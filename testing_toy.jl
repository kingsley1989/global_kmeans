...
Random.seed!(123)
clst_n = 15 # number of points in a cluster
k = 3
...
@time centers_adp, objv_adp, calcInfo_adp = bb_functions.branch_bound_adptGp(toy_data, k) # 237s 11 iterations
# @time centers_adp_LD, objv_adp_LD, calcInfo_adp_LD = bb_functions.branch_bound_adptGp_LD(toy_data, k) # 233s 1 node with 20 updates of lambda
...
nestedEval(toy_data, label, centers_adp, objv_adp) # evaluation with adpative grouping bb
