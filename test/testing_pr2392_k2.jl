...
if Sys.iswindows()
    data, label = data_preprocess("pr2392.tsp", nothing, joinpath(@__DIR__, "..\\data\\")) # read data in Windows
else
    data, label = data_preprocess("pr2392.tsp", nothing, joinpath(@__DIR__, "data/")) # read data in Mac
end
